<template>
  <main class="bg-gray-100">
    <section class="px-8 py-12">
      <div class>
        <svg class="h-10" viewBox="0 0 185 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <img src="http://127.0.0.1:8080/img/beach-work.jpg" alt class="mt-6 rounded-lg shadow-xl" />
        <h3 class="text-gray-900 text-2xl leading-tight font-bold mt-2">
        ...
        <div class="mt-4">
          <a href class>Book your escape</a>
        </div>
      </div>
    </section>
    <section class="bg-gray-200 px-8 py-12">
      <div class>
        <h5 class="text-gray-900 text-xl">Popular destinations</h5>
        <p
          class="text-gray-600"
        ...
        <div
          ...
          :key="index"
          class="bg-white flex items-center mt-6 overflow-hidden rounded-lg shadow-lg"
        >
          <img :src="destination.img" alt class="object-cover w-32" />
          <div class="ml-4">
            <h4 class="text-gray-800 text-lg font-semibold">{{destination.location}}</h4>
            <p class="text-gray-600">{{destination.price}}</p>
            <div class="mt-4">
              <a href class="text-indigo-500 text-sm font-semibold">{{destination.count}}</a>
            </div>
          </div>
        </div>
      </div>
...
export default {
  data: () => {
    return {
      destinations: [
        {
          img: "http://127.0.0.1:8080/img/toronto.jpg",
          location: "Toronto",
          price: "$120 / night average",
          count: "Explore 76 properties"
        },
        {
          img: "http://127.0.0.1:8080/img/malibu.jpg",
          location: "Malibu",
          price: "$215 / night average",
          count: "Explore 43 properties"
        },
        {
          img: "http://127.0.0.1:8080/img/chicago.jpg",
          location: "Chicago",
          price: "$130 / night average",
          count: "Explore 115 properties"
        },
        {
          img: "http://127.0.0.1:8080/img/chicago.jpg",
          location: "Seattle",
          price: "$135 / night average",
          count: "Explore 63 properties"
        },
        {
          img: "http://127.0.0.1:8080/img/colorado.jpg",
          location: "Miami",
          price: "$115 / night average",
          count: "Explore 86 properties"
        }
      ]
    };
  }
